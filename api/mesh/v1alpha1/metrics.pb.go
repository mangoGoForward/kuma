...
type PrometheusMetricsBackendConfig struct {
	...
	// Map with configuration of applications that are going to be scrapped.
	Aggregate map[string]*PrometheusServicesMetricsAggregateConfig `protobuf:"bytes,5,rep,name=aggregate,proto3" json:"aggregate,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *PrometheusMetricsBackendConfig) GetAggregate() map[string]*PrometheusServicesMetricsAggregateConfig {
	if x != nil {
		return x.Aggregate
	}
	return nil
...
// PrometheusServicesMetricsAggregateConfig defines endpoints that should be scrapped
// by kuma-dp and then expose
type PrometheusServicesMetricsAggregateConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Port on which a service should expose HTTP endpoint with Prometheus
	// metrics.
	Port uint32 `protobuf:"varint,1,opt,name=port,proto3" json:"port,omitempty"`
	// Path on which a service should expose HTTP endpoint with Prometheus
	// metrics.
	Path string `protobuf:"bytes,2,opt,name=path,proto3" json:"path,omitempty"`
	// If true then application won't be scrapped. If nil, then it is treated as true.
	Enabled *wrapperspb.BoolValue `protobuf:"bytes,3,opt,name=enabled,proto3" json:"enabled,omitempty"`
}

func (x *PrometheusServicesMetricsAggregateConfig) Reset() {
	*x = PrometheusServicesMetricsAggregateConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *PrometheusServicesMetricsAggregateConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PrometheusServicesMetricsAggregateConfig) ProtoMessage() {}

func (x *PrometheusServicesMetricsAggregateConfig) ProtoReflect() protoreflect.Message {
	mi := &file_mesh_v1alpha1_metrics_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PrometheusServicesMetricsAggregateConfig.ProtoReflect.Descriptor instead.
func (*PrometheusServicesMetricsAggregateConfig) Descriptor() ([]byte, []int) {
	return file_mesh_v1alpha1_metrics_proto_rawDescGZIP(), []int{3}
}

func (x *PrometheusServicesMetricsAggregateConfig) GetPort() uint32 {
	if x != nil {
		return x.Port
	}
	return 0
...
func (x *PrometheusServicesMetricsAggregateConfig) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
func (x *PrometheusServicesMetricsAggregateConfig) GetEnabled() *wrapperspb.BoolValue {
	if x != nil {
		return x.Enabled
	}
	return nil
...
var file_mesh_v1alpha1_metrics_proto_rawDesc = []byte{
	...
	0x75, 0x63, 0x74, 0x52, 0x04, 0x63, 0x6f, 0x6e, 0x66, 0x22, 0xe8, 0x03, 0x0a, 0x1e, 0x50, 0x72,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x7a, 0x0a, 0x0e, 0x41, 0x67, 0x67, 0x72,
	...
	,
...
var file_mesh_v1alpha1_metrics_proto_goTypes = []interface{}{
	...
	(*PrometheusServicesMetricsAggregateConfig)(nil), // 3: kuma.mesh.v1alpha1.PrometheusServicesMetricsAggregateConfig
...
var file_mesh_v1alpha1_metrics_proto_depIdxs = []int32{
	...
	7, // 5: kuma.mesh.v1alpha1.PrometheusServicesMetricsAggregateConfig.enabled:type_name -> google.protobuf.BoolValue
	3, // 6: kuma.mesh.v1alpha1.PrometheusMetricsBackendConfig.AggregateEntry.value:type_name -> kuma.mesh.v1alpha1.PrometheusServicesMetricsAggregateConfig
...
func file_mesh_v1alpha1_metrics_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mesh_v1alpha1_metrics_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PrometheusServicesMetricsAggregateConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
